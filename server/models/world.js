...
export const World = $root.World = (() => {
    ...
    World.encode = function encode(message, writer) {
        ...
        if (message.paddle != null && message.hasOwnProperty("paddle"))
            $root.Paddle.encode(message.paddle, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        if (message.arrow != null && message.hasOwnProperty("arrow"))
            $root.Arrow.encode(message.arrow, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
        if (message.bricks != null && message.bricks.length)
            for (let i = 0; i < message.bricks.length; ++i)
        ...
        if (message.won != null && message.hasOwnProperty("won"))
            writer.uint32(/* id 6, wireType 0 =*/48).bool(message.won);
        if (message.lost != null && message.hasOwnProperty("lost"))
            writer.uint32(/* id 7, wireType 0 =*/56).bool(message.lost);
        if (message.frameNb != null && message.hasOwnProperty("frameNb"))
            writer.uint32(/* id 8, wireType 0 =*/64).int32(message.frameNb);
        if (message.preFrameNb != null && message.hasOwnProperty("preFrameNb"))
            writer.uint32(/* id 9, wireType 0 =*/72).int32(message.preFrameNb);
        if (message.request != null && message.hasOwnProperty("request"))
            $root.Request.encode(message.request, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
        return writer;
    };
    ...
    World.verify = function verify(message) {
        ...
        if (message.paddle != null && message.hasOwnProperty("paddle")) {
            let error = $root.Paddle.verify(message.paddle);
            if (error)
                return "paddle." + error;
        }
        if (message.arrow != null && message.hasOwnProperty("arrow")) {
            let error = $root.Arrow.verify(message.arrow);
            if (error)
                return "arrow." + error;
        }
        if (message.bricks != null && message.hasOwnProperty("bricks")) {
            if (!Array.isArray(message.bricks))
                return "bricks: array expected";
            for (let i = 0; i < message.bricks.length; ++i) {
                let error = $root.Brick.verify(message.bricks[i]);
                if (error)
                    return "bricks." + error;
            }
        }
        ...
        if (message.won != null && message.hasOwnProperty("won"))
            if (typeof message.won !== "boolean")
                return "won: boolean expected";
        if (message.lost != null && message.hasOwnProperty("lost"))
            if (typeof message.lost !== "boolean")
                return "lost: boolean expected";
        if (message.frameNb != null && message.hasOwnProperty("frameNb"))
            if (!$util.isInteger(message.frameNb))
                return "frameNb: integer expected";
        if (message.preFrameNb != null && message.hasOwnProperty("preFrameNb"))
            if (!$util.isInteger(message.preFrameNb))
                return "preFrameNb: integer expected";
        if (message.request != null && message.hasOwnProperty("request")) {
    ...
    World.fromObject = function fromObject(object) {
        ...
        if (object.ball != null) {
            if (typeof object.ball !== "object")
                throw TypeError(".World.ball: object expected");
            message.ball = $root.Ball.fromObject(object.ball);
        }
        if (object.paddle != null) {
            if (typeof object.paddle !== "object")
                throw TypeError(".World.paddle: object expected");
            message.paddle = $root.Paddle.fromObject(object.paddle);
        }
        if (object.arrow != null) {
            if (typeof object.arrow !== "object")
                throw TypeError(".World.arrow: object expected");
            message.arrow = $root.Arrow.fromObject(object.arrow);
        }
        if (object.bricks) {
            if (!Array.isArray(object.bricks))
                throw TypeError(".World.bricks: array expected");
            message.bricks = [];
            for (let i = 0; i < object.bricks.length; ++i) {
                if (typeof object.bricks[i] !== "object")
                    throw TypeError(".World.bricks: object expected");
        ...
        if (object.won != null)
            message.won = Boolean(object.won);
        if (object.lost != null)
            message.lost = Boolean(object.lost);
        if (object.frameNb != null)
            message.frameNb = object.frameNb | 0;
        if (object.preFrameNb != null)
            message.preFrameNb = object.preFrameNb | 0;
    ...
    World.toObject = function toObject(message, options) {
        ...
        if (message.paddle != null && message.hasOwnProperty("paddle"))
            object.paddle = $root.Paddle.toObject(message.paddle, options);
        if (message.arrow != null && message.hasOwnProperty("arrow"))
            object.arrow = $root.Arrow.toObject(message.arrow, options);
        if (message.bricks && message.bricks.length) {
            object.bricks = [];
            for (let j = 0; j < message.bricks.length; ++j)
                object.bricks[j] = $root.Brick.toObject(message.bricks[j], options);
        }
        if (message.action != null && message.hasOwnProperty("action"))
            object.action = options.enums === String ? $root.Action[message.action] : message.action;
        if (message.won != null && message.hasOwnProperty("won"))
            object.won = message.won;
        if (message.lost != null && message.hasOwnProperty("lost"))
            object.lost = message.lost;
        if (message.frameNb != null && message.hasOwnProperty("frameNb"))
            object.frameNb = message.frameNb;
        if (message.preFrameNb != null && message.hasOwnProperty("preFrameNb"))
...
export const Ball = $root.Ball = (() => {
    ...
    Ball.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.xPx != null && message.hasOwnProperty("xPx"))
            writer.uint32(/* id 1, wireType 5 =*/13).float(message.xPx);
        if (message.yPx != null && message.hasOwnProperty("yPx"))
            writer.uint32(/* id 2, wireType 5 =*/21).float(message.yPx);
        if (message.radiusPx != null && message.hasOwnProperty("radiusPx"))
            writer.uint32(/* id 3, wireType 5 =*/29).float(message.radiusPx);
        if (message.linearVelocityXM != null && message.hasOwnProperty("linearVelocityXM"))
            writer.uint32(/* id 4, wireType 5 =*/37).float(message.linearVelocityXM);
        if (message.linearVelocityYM != null && message.hasOwnProperty("linearVelocityYM"))
            writer.uint32(/* id 5, wireType 5 =*/45).float(message.linearVelocityYM);
        if (message.canMove != null && message.hasOwnProperty("canMove"))
            writer.uint32(/* id 6, wireType 0 =*/48).bool(message.canMove);
        if (message.bouncing != null && message.hasOwnProperty("bouncing"))
            writer.uint32(/* id 7, wireType 0 =*/56).bool(message.bouncing);
    ...
    Ball.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.xPx != null && message.hasOwnProperty("xPx"))
            if (typeof message.xPx !== "number")
                return "xPx: number expected";
        if (message.yPx != null && message.hasOwnProperty("yPx"))
            if (typeof message.yPx !== "number")
                return "yPx: number expected";
        if (message.radiusPx != null && message.hasOwnProperty("radiusPx"))
            if (typeof message.radiusPx !== "number")
                return "radiusPx: number expected";
        if (message.linearVelocityXM != null && message.hasOwnProperty("linearVelocityXM"))
            if (typeof message.linearVelocityXM !== "number")
                return "linearVelocityXM: number expected";
        if (message.linearVelocityYM != null && message.hasOwnProperty("linearVelocityYM"))
            if (typeof message.linearVelocityYM !== "number")
                return "linearVelocityYM: number expected";
        if (message.canMove != null && message.hasOwnProperty("canMove"))
            if (typeof message.canMove !== "boolean")
                return "canMove: boolean expected";
        if (message.bouncing != null && message.hasOwnProperty("bouncing"))
            if (typeof message.bouncing !== "boolean")
                return "bouncing: boolean expected";
        if (message.dead != null && message.hasOwnProperty("dead"))
    ...
    Ball.fromObject = function fromObject(object) {
        ...
        if (object.xPx != null)
            message.xPx = Number(object.xPx);
        if (object.yPx != null)
            message.yPx = Number(object.yPx);
        if (object.radiusPx != null)
            message.radiusPx = Number(object.radiusPx);
        if (object.linearVelocityXM != null)
            message.linearVelocityXM = Number(object.linearVelocityXM);
        if (object.linearVelocityYM != null)
            message.linearVelocityYM = Number(object.linearVelocityYM);
        if (object.canMove != null)
            message.canMove = Boolean(object.canMove);
        if (object.bouncing != null)
            message.bouncing = Boolean(object.bouncing);
        if (object.dead != null)
    ...
    Ball.toObject = function toObject(message, options) {
        ...
        if (message.xPx != null && message.hasOwnProperty("xPx"))
            object.xPx = options.json && !isFinite(message.xPx) ? String(message.xPx) : message.xPx;
        if (message.yPx != null && message.hasOwnProperty("yPx"))
            object.yPx = options.json && !isFinite(message.yPx) ? String(message.yPx) : message.yPx;
        if (message.radiusPx != null && message.hasOwnProperty("radiusPx"))
            object.radiusPx = options.json && !isFinite(message.radiusPx) ? String(message.radiusPx) : message.radiusPx;
        if (message.linearVelocityXM != null && message.hasOwnProperty("linearVelocityXM"))
            object.linearVelocityXM = options.json && !isFinite(message.linearVelocityXM) ? String(message.linearVelocityXM) : message.linearVelocityXM;
        if (message.linearVelocityYM != null && message.hasOwnProperty("linearVelocityYM"))
            object.linearVelocityYM = options.json && !isFinite(message.linearVelocityYM) ? String(message.linearVelocityYM) : message.linearVelocityYM;
        if (message.canMove != null && message.hasOwnProperty("canMove"))
            object.canMove = message.canMove;
        if (message.bouncing != null && message.hasOwnProperty("bouncing"))
            object.bouncing = message.bouncing;
        if (message.dead != null && message.hasOwnProperty("dead"))
...
export const Paddle = $root.Paddle = (() => {
    ...
    Paddle.encode = function encode(message, writer) {
        ...
        if (message.widthPx != null && message.hasOwnProperty("widthPx"))
            writer.uint32(/* id 3, wireType 5 =*/29).float(message.widthPx);
        if (message.heightPx != null && message.hasOwnProperty("heightPx"))
            writer.uint32(/* id 4, wireType 5 =*/37).float(message.heightPx);
        if (message.canMove != null && message.hasOwnProperty("canMove"))
    ...
    Paddle.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Paddle();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    Paddle.verify = function verify(message) {
        ...
        if (message.widthPx != null && message.hasOwnProperty("widthPx"))
            if (typeof message.widthPx !== "number")
                return "widthPx: number expected";
        if (message.heightPx != null && message.hasOwnProperty("heightPx"))
            if (typeof message.heightPx !== "number")
                return "heightPx: number expected";
        if (message.canMove != null && message.hasOwnProperty("canMove"))
            if (typeof message.canMove !== "boolean")
                return "canMove: boolean expected";
        return null;
    ...
    Paddle.fromObject = function fromObject(object) {
        if (object instanceof $root.Paddle)
            return object;
        let message = new $root.Paddle();
        if (object.xPx != null)
            message.xPx = Number(object.xPx);
        if (object.yPx != null)
            message.yPx = Number(object.yPx);
        if (object.widthPx != null)
            message.widthPx = Number(object.widthPx);
        if (object.heightPx != null)
            message.heightPx = Number(object.heightPx);
        if (object.canMove != null)
            message.canMove = Boolean(object.canMove);
        return message;
    };
    ...
    Paddle.toObject = function toObject(message, options) {
        ...
        if (message.yPx != null && message.hasOwnProperty("yPx"))
            object.yPx = options.json && !isFinite(message.yPx) ? String(message.yPx) : message.yPx;
        if (message.widthPx != null && message.hasOwnProperty("widthPx"))
            object.widthPx = options.json && !isFinite(message.widthPx) ? String(message.widthPx) : message.widthPx;
        if (message.heightPx != null && message.hasOwnProperty("heightPx"))
            object.heightPx = options.json && !isFinite(message.heightPx) ? String(message.heightPx) : message.heightPx;
        if (message.canMove != null && message.hasOwnProperty("canMove"))
            object.canMove = message.canMove;
        return object;
    };
...
export const Arrow = $root.Arrow = (() => {
    ...
    Arrow.encode = function encode(message, writer) {
        ...
        if (message.yPx != null && message.hasOwnProperty("yPx"))
            writer.uint32(/* id 2, wireType 5 =*/21).float(message.yPx);
        if (message.angularVelocityXM != null && message.hasOwnProperty("angularVelocityXM"))
    ...
    Arrow.verify = function verify(message) {
        ...
        if (message.yPx != null && message.hasOwnProperty("yPx"))
            if (typeof message.yPx !== "number")
                return "yPx: number expected";
        if (message.angularVelocityXM != null && message.hasOwnProperty("angularVelocityXM"))
            if (typeof message.angularVelocityXM !== "number")
                return "angularVelocityXM: number expected";
        if (message.angularVelocityYM != null && message.hasOwnProperty("angularVelocityYM"))
    ...
    Arrow.fromObject = function fromObject(object) {
        ...
        if (object.yPx != null)
            message.yPx = Number(object.yPx);
        if (object.angularVelocityXM != null)
...
export const Brick = $root.Brick = (() => {
    ...
    Brick.encode = function encode(message, writer) {
        ...
        if (message.lives != null && message.hasOwnProperty("lives"))
            writer.uint32(/* id 5, wireType 0 =*/40).uint32(message.lives);
        return writer;
    };
    ...
    Brick.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Brick();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    Brick.fromObject = function fromObject(object) {
        if (object instanceof $root.Brick)
            return object;
        let message = new $root.Brick();
        if (object.xPx != null)
            message.xPx = Number(object.xPx);
        if (object.yPx != null)
            message.yPx = Number(object.yPx);
