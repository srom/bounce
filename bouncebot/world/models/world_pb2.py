...
# source: protobuf_models/world.proto
...
World = _reflection.GeneratedProtocolMessageType('World', (_message.Message,), dict(
  DESCRIPTOR = _WORLD,
  __module__ = 'protobuf_models.world_pb2'
